...
describe('SectionElementEditingComponent', () => {
  ...
  // it('deleteTest_deletesSectionElementAtIndexInStudyAndArrayInClass', () => {
  //   component = new SectionElementEditingComponent(new StudyWrapperService(), null);
  //   component.studywrapper.study = createDefaultStudyPrototype();
  //   const s1 = new SectionElement(0, "Lange Vibrationen", RandomizingStrategies.NONE);
  //   const s2 = new SectionElement(1, "Kurze Vibrationen", RandomizingStrategies.NONE);
  //   const s3 = new SectionElement(2, "Kurze Vibrationen", RandomizingStrategies.NONE);
  //   const sectionElements: SectionElement[] = [s1, s2, s3];
  //   component.studywrapper.study.sectionElements = sectionElements;
  //   component.sectionelements = sectionElements;
  //   expect(component.sectionelements.length).toEqual(3);
  //   component.ngOnInit();
  //   component.deleteTest(0);
  //   expect(component.sectionelements.length).toEqual(2);
  //   expect(component.sectionelements[0]).toEqual(s3);
  //   expect(component.studywrapper.study.sectionElements[0]).toEqual(s3);
  // });
